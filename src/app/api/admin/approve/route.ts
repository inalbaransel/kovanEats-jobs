    ...
    if (process.env.RESEND_API_KEY) {
      try {
        const result = await resend.emails.send({
          ...
          to: [email],
          subject: "🎉 Tebrikler! KovanEats'e Hoş Geldin!",
          html: `
            <!DOCTYPE html>
            <html>
              <head>
                ...
                <style>
                  ...
                  h1 { font-size: 26px; font-weight: 800; letter-spacing: -0.5px; margin: 0 0 16px 0; color: #000; }
              ...
              <body>
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <p>En kısa sürede, bu mail adresi üzerinden sana ulaşacak ve sonraki adımları paylaşacağız.</p>
